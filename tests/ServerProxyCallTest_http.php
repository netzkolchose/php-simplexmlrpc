...
class ServerProxyCallTest_http extends ServerProxyCallTestBase
{
    ...
    public static function setUpBeforeClass() {
        ...
        self::$p_handle = proc_open(
            "python -u tests/test_server.py http localhost 8080 2>&1",
            array(
                0 => array("pipe", "r"),
                1 => array("pipe", "w"),
                2 => array("pipe", "w")
        ...
        $s = new \SimpleXmlRpc\ServerProxy("http://localhost:8080");
        while (TRUE) {
            usleep(50);
    ...
    public function setUp() {
        $this->serverproxy = new \SimpleXmlRpc\ServerProxy("http://localhost:8080");
    }
